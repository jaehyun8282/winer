...
<body>
 ...
 <form action="wproduct" method="post" enctype="multipart/form-data">
 		<fieldset>
 			...
 			<div class="form-group">
 				<label>상품부제</label>
 				<input type="text" name="p_sname" class="form-control" required="required">
 			</div>
 			<div class="form-group">
 				<label>상품 가격 </label>
 				<input style="width: 95%; display: inline; text-align: right;" 
 				type="number" class="form-control" name="p_price" required="required" id="price">원
 			</div>
 			<div class="form-group">
 				<label>할인률</label><br>
 				<input style="width: 63%; display: inline; text-align: right;" type="text" class="form-control" name="p_sale" required="required" id="sale">(%)
 			...
 			<div class="form-group">
 				<label>상품 수량</label>
 				<input type="text" style="width: 95%; display: inline; text-align: right;" class="form-control" name="p_count" required="required">개
 			</div>
 			<br>
 		<div class="form-group" align="center">
 			<input type="reset" value="취소" class="btn btn-danger">
 			<input type="submit" value="상품 등록" class="btn btn-info">
